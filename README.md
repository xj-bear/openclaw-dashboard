...
### 🌐 WebUI 域名跳转设置
如果您在面板的设置项中配置 **WebUI 自定义域名**，请务必输入**完整的地址**（包含协议、IP/域名及端口）：
- ✅ 正确示例：`http://154.64.236.***:18789` 或 `https://chat.example.com`
- ❌ 错误示例：`154.64.236.***:18789` (缺少 http://，会导致浏览器跳转到本地地址)

配置完成后，点击面板右上角的 **"WebUI"** 按钮即可实现平滑跳转。
